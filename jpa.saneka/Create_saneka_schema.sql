...
CREATE TABLE CENTRO (ID INTEGER NOT NULL, DIRECCION VARCHAR NOT NULL, NOMBRE VARCHAR NOT NULL, TLF_CONSEJERIA VARCHAR, PRIMARY KEY (ID))
CREATE TABLE CLASE (DIA INTEGER NOT NULL, HORA_INICIO VARCHAR NOT NULL, HORA_FIN VARCHAR, ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID INTEGER NOT NULL UNIQUE, PRIMARY KEY (DIA, HORA_INICIO, GRUPO_ID))
...
CREATE TABLE MATRICULA (CURSO_ACADEMICO VARCHAR NOT NULL, ESTADO VARCHAR, FECHA_MATRICULA VARCHAR NOT NULL, LISTADO_ASIGNATURAS VARCHAR, NUEVO_INGRESO VARCHAR, NUM_ARCHIVO INTEGER, TURNO_PREFERENTE VARCHAR, EXPEDIENTE_NUM_EXPEDIENTE INTEGER NOT NULL, PRIMARY KEY (CURSO_ACADEMICO, EXPEDIENTE_NUM_EXPEDIENTE))
