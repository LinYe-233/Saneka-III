...
public class AsignaturaEJB implements GestionAsignatura{
	...
	@Override
	public String mostrarAsignatura(Asignatura asignatura) throws AsignaturaNoEncontradoException {
	...
	@Override
	public void modificarAsignatura(Asignatura asignatura) throws AsignaturaNoEncontradoException {
		Asignatura existente = em.find(Asignatura.class, asignatura.getReferencia());
		if (existente==null) {
			throw new AsignaturaNoEncontradoException();
		}
